...
function Product() {
  return (
    <div className='text-center'>
      ...
      <h1 className='md:text-4xl text-2xl font-extrabold text-sky-600'>Products Offering</h1>
      ...
      <h1 className='md:text-4xl text-2xl font-extrabold text-sky-600 text-center'>Products Detail</h1>
      <div className="flex justify-center mt-[3rem]">
